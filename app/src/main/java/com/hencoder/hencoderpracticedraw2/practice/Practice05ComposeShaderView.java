...
public class Practice05ComposeShaderView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        Shader batmanLogoShader=new BitmapShader(bitmapLogo,Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);

        // ComposeShader：结合两个 Shader  A as its
        //"dst", and the result from shader B as its "src".
        Shader shader = new ComposeShader(batmanShader, batmanLogoShader, PorterDuff.Mode.DST_IN);
